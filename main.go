// Package gzip provider a baa middleware for compress to responses.
package gzip
...
// Gzip returns a baa middleware for compress to responses
func Gzip(opt Options) baa.HandlerFunc {
	pool := gzipPool(opt)
